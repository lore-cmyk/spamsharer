...
def check_expiration():
    ...
    if elapsed_time > 3600:
        owner_facebook_url = "https://www.facebook.com/helloworld5463882"  # Replace with the correct URL
        st.warning(f"Avail to the Owner to Access this Premium Share Booster. [Contact Owner]({owner_facebook_url})")
        st.stop()  # Stop the execution of the app

def Execute(cookie, post, share_count, delay):
    check_expiration()  # Check expiration before executing
...
with COOKIEm:
    ...
    if st.button("Submit", type='primary',key="aa1"):
        check_expiration()  # Check expiration before submitting
